    ...
    mounted(){
        ...
        if(bannertypeid){
            if(this.bannertypes && this.bannertypes.length>0){
                let banner = this.bannertypes.find(block=>block.bannerid==this.bannertypeid)
            } else {
        ...
        bannertypes:function(){
            ...
            if(bannertypeid){
                if(this.bannertypes && this.bannertypes.length>0){
                    ...
                    console.log(this.bannertypes.length)
                    console.log(bannertypeid)
                    let banner = this.bannertypes.find(block=>block.bannerid==bannertypeid)
                    console.log(banner)
